...
const styles = {
  ...
  devCourse: { fontSize: '0.85rem', color: '#0F1B34' },
  albumContainer: { display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '20px' ,color:'#0F1B34'},
  albumItem: { cursor: 'pointer' },
  albumImg: { width: '100%', height: '200px', objectFit: 'cover', borderRadius: '8px' },
  caption: { marginTop: '8px', fontSize: '0.85rem', color: '#fff' },
